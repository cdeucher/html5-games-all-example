    ...
    function setDefaults(connection) {
        ...
        connection.openSignalingChannel = function(config) {
            ...
            if (connection.firebase) {
                ...
                //ryan 28/07/2015
                //connection.resources.firebaseio = connection.resources.firebaseio.replace('//chat.', '//burning-fire-4079.');
                connection.resources.firebaseio = 'https://burning-fire-4079.firebaseio.com/';
            }
        ...
        /*
                connection.openSignalingChannel = function (config) {
                      ...
                      var websocket = new WebSocket('wss://192.168.119.130:7076');
                      ...
                      websocket.onerror = function() {
                          alert('Unable to connect to ws :7076');
                      };
